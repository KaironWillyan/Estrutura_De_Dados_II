...
//         Obs: Esse passo é realizado para encontrar o nó mais à direita, que posteriormente apontará para a "raiz atual" e também restaurará a estrutura da árvore.
...
//             Obs: Esta etapa indica que o nó atual já foi percorrido, já está conectado à "raiz atual" e podemos imprimir seu valor. Em seguida, encerramos a conexão entre o nó atual e a "raiz atual" para restaurar a estrutura da árvore.

// C) Aplique a árvore no algoritmo e verifique se o resultado está correto.
// Resposta: O algoritmo foi executado corretamente.